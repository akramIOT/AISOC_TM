...
def generate_sql_query(requirement: str) -> str:
    ...
    few_shot_prompt = FewShotPromptTemplate(
        ...
        prefix="You are an expert SQL query generator. Convert the following requirements to SQL queries:\n",
        suffix="\nInput: {input}\nQuery:",
...
# Main Streamlit app
def main():
    st.title("Application Management with GENAI based Automated SQL Query Generation using Agentic Approach")
    ...
    requirement = st.selectbox(
        ...
        [
            ...
            "Users have reported unusual account activity. Create monitoring to detect anomalous user session patterns that could indicate account compromise.",
            ...
            "Create proactive monitoring for resource utilization across our microservices.",
        ],
    )
